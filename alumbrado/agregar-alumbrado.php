<?php 
    ...
    if(isset($_POST['agregar'])){
        ...
        if(empty($descripcion) || empty($ubicacion)){
            $_SESSION['error_alumbrado'] = 'Todos los campos son obligatorios para crear un reporte';
            header('Location: /infraestructura/alumbrado/alumbrado.php');
            exit;
        }
        
        $stmt = $pdo->prepare("INSERT INTO reportes (id_cedula, tipo_reporte, descripcion, ubicacion) VALUES (30490358, 3, :descripcion, :ubicacion)");
        $stmt->execute([
...
<body>
    <div style="margin-top: 150px;" class="container">
        <form class="form" action="agregar-alumbrado.php" method="POST">
