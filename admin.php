...
<body>
    <header class="header">
        <a href="/infraestructura/admin.php">
        ...
        <nav class="nav">
            <!-- <a class="nav__link" href="calles/calles.php">Calles</a>
            <a class="nav__link" href="tuberias/tuberias.php">Tuberias</a>
            <a class="nav__link" href="alumbrado/alumbrado.php">Alumbrado</a> -->
        </nav class="nav">
        <div class="nav">
    ...
    <main>
        <h1 class="title--admin">Panel de Administración</h1>
        <div class="container">
            <div class="card">
                <h3 class="card__title">Calles</h3>
                <img style="width: 100%; height: 300px; border-radius: 20px;" src="assets/img/jared-murray-NSuufgf-BME-unsplash.jpg" alt="">
                <p class="card__text">Administra los reportes de las calles de la ciudad</p>
                <a style="margin-top: 20px;" class="btn" href="calles/calles.php">Ver reportes</a>
            </div>
            <div class="card">
                <h3 class="card__title">Tuberias</h3>
                <img style="width: 100%; height: 300px; border-radius: 20px;" src="assets/img/WhatsApp Image 2025-01-29 at 5.55.42 PM.jpeg" alt="">
                <p class="card__text">Administra los reportes de las tuberias de la ciudad</p>
                <a style="margin-top: 20px;" class="btn" href="tuberias/tuberias.php">Ver reportes</a>
            </div>
            <div class="card">
                <h3 class="card__title">Alumbrado</h3>
                <img style="width: 100%; height: 300px; border-radius: 20px;" src="assets/img/WhatsApp Image 2025-01-29 at 5.59.07 PM.jpeg" alt="">
                <p class="card__text">Administra los reportes de el alumbrado de la ciudad</p>
                <a style="margin-top: 20px;" class="btn" href="alumbrado/alumbrado.php">Ver reportes</a>
            </div>
        </div>
    </main>
</body>
