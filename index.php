...
<body>
    <header class="header">
        ...
        <nav class="nav">
            <a class="btn btn--white" href="/infraestructura/register.php">Registrate</a>
            <a class="btn" href="/infraestructura/login.php">Iniciar Sesión</a>
        </nav>
    </header>
    <main>
        <section class="section">
            <h1 class="title">SySReport</h1>
            <p class="section__paragraph">Reporta de manera sencilla y rápida cualquier falla en el alumbrado público, problemas de tuberías o el estado de las calles en tu comunidad</p>
            <div class="ilustrations">
                <img class="img" src="assets/img/undraw_read-notes_7itt.svg" alt="">
                <img class="img img--modifier" src="assets/img/undraw_notifications_bw0p.svg" alt="">
            </div>
        </section>
    </main>
</body>
